                        ...
                        <div className="row margin-top1 margin-bottom1">
                            ...
                            <form class="form">
                                ...
                                {/*<div class="col-lg-6 col-lg-offset-1">
                                    <input type="button" class="form-control btn btn-primary fbbutton " id="fbRegisterButton" value="Facebook Login"/>
                                </div>
                                <div class="col-lg-6 col-lg-offset-1">
                                    <button type="button" class="form-control btn gbutton " id="fbRegisterButton" >
                                        Google Login
                                </button>
